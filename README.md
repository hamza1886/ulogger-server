...
Together with a dedicated [μlogger mobile client](https://github.com/hamza1886/ulogger-android) it may be used as a complete self hosted server–client solution for logging and monitoring users' geolocation.
